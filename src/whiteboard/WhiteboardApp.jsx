...
const PEN_COLORS = ['#211E1A', '#756F64', '#2B7FD8', '#F4D758'];
const PEN_WIDTHS = [3, 6, 11];
const SEED_VOTES_KEY = 'hresh.wb.seedVotes.v1';
const SEED_OVERRIDES_KEY = 'hresh.wb.seedOverrides.v1';
      ...
      {qrSrc && (
        <div className="wb-modal-backdrop" onClick={() => setQrSrc(null)}>
          <div className="wb-modal wb-qr-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <img className="wb-qr-img" src={qrSrc} alt="联系二维码" draggable={false} />
